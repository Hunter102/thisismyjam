    ...
    return (
        <footer className="w-full bg-foreground py-8 border-y-8 border-white">
            <div className="max-w-7xl mx-auto px-6">
                <div className="grid grid-rows-1 md:grid-cols-3 gap-10 text-background text-lg justify-items-center md:justify-between">
                    {/* Company Section */}
                    <div className="text-center md:text-left">
                        <h2 className="font-bold text-xl text-lbl mb-4">Company</h2>
                    ...
                    <div className="text-center md:text-left">
                        <h2 className="font-bold text-xl text-lbl mb-4">Terms & Policies</h2>
                        <ul className="space-y-2">
                            <li>
                    ...
                    {/* Socials Section */}
                    <div className="text-center md:text-left">
                        <h2 className="font-bold text-xl text-lbl mb-4">Socials</h2>
